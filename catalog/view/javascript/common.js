...
$(document).ready(function() {
	...
	category_name.appendTo(breadcrumbs_container);
	...
	// Product List
        ...
        $('#grid-view').click(function() {
            ...
            if (cols == 2) {
                $('#content .product-list').attr('class', 'product-layout product-grid module-style1 col-lg-6 col-md-6 col-sm-6 col-xs-6 product-item');
            } else if (cols == 1) {
                $('#content .product-list').attr('class', 'product-layout product-grid module-style1 col-lg-4 col-md-4 col-sm-6 col-xs-6 product-item');
            } else {
                $('#content .product-list').attr('class', 'product-layout product-grid module-style1 col-lg-3 col-md-3 col-sm-6 col-xs-6 product-item');
            }
